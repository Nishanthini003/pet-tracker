...
interface OfficerAuthFormProps {
  onSubmit: (data: { email: string; badgeNumber: string; password: string }) => void;
  disabled?: boolean;
}

export const OfficerAuthForm = ({ onSubmit, disabled = false }: OfficerAuthFormProps) => {
